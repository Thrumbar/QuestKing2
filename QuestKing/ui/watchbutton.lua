...
local QUEST_ICON_COMPLETE = [[Interface\GossipFrame\ActiveQuestIcon]]
local QUEST_ICON_EXCLAMATION = "QuestIcon-Exclamation"
local QUEST_ICON_QUESTION_MARK = "QuestIcon-QuestionMark"
...
do
    ...
    local function buttonSetIcon(self, iconType)
        ...
        if iconType == QUEST_ICON_QUESTION_MARK then
            icon:SetTexture(QUEST_ICON_COMPLETE)
        else
            icon:SetTexture(QUEST_ICON_AVAILABLE)
        end
